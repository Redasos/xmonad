...
myKeys conf@(XConfig {XMonad.modMask = modm}) = M.fromList $
    ...
    -- launch dmenu
    , ((modm .|. shiftMask, xK_F1    ), spawn "dmenu_run")
    , ((modm .|. shiftMask, xK_F2    ), spawn "min")
    , ((modm .|. shiftMask, xK_F3    ), spawn "thunar")
    , ((modm .|. shiftMask, xK_F4    ), spawn "mousepad")
    , ((modm .|. shiftMask, xK_F5    ), spawn "firefox")
    , ((modm .|. shiftMask, xK_F6    ), spawn "rofi -show run")
    , ((modm .|. shiftMask, xK_F7    ), spawn "rofi -show drun")
    , ((modm .|. shiftMask, xK_F9    ), spawn "amixer set Master 10%- unmute")
    , ((modm .|. shiftMask, xK_F10    ), spawn "amixer set Master 10%+ unmute")
    , ((modm .|. shiftMask, xK_F11    ), spawn "poweroff")
    -- launch gmrun
